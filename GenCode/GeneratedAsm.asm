...
find_len				PROTO
_first PROTO : DWORD
_second PROTO : SBYTE,: SBYTE

.const
newStr BYTE 10, 13
newStr_len BYTE 2
zeroEx BYTE "Division by zero", 0
literal5 BYTE "GRD-2021", 0 
literal9 SBYTE 0b
...
ret
_first ENDP
_second PROC  a6: SBYTE, b6: SBYTE
mov ah, a6
mov al, literal9
.if ah < al
...
invoke _first,  offset literal27
